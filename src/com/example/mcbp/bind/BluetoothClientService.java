...
public class BluetoothClientService {
    ...
    //public int mRetry = 2;	//retry allows on failure
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        pM.updateBindBT(device.getName(), device.getAddress());
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            int bytes;
            byte[] uuidBuffer = buildBindMsg().getBytes();
            write(uuidBuffer);
